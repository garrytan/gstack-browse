...
8. **Solana** — if STACK contains "solana" (Anchor.toml detected or Cargo.toml references anchor-lang/solana-program/solana-sdk). Read `~/.claude/skills/gstack/review/specialists/solana.md`
