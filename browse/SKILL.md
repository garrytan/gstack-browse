...
~/.claude/skills/gstack/bin/gstack-session-cleanup 2>/dev/null || true
...
~/.claude/skills/gstack/bin/gstack-pending-finalize "~/.claude/skills/gstack/bin/gstack-telemetry-log" "$_SESSION_ID" "$_TEL" 2>/dev/null || true
# Learnings count
