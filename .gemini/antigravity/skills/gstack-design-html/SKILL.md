...
_PRETEXT_VENDOR=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.antigravity/skills/gstack/design-html/vendor/pretext.js" ] && _PRETEXT_VENDOR="$_ROOT/.antigravity/skills/gstack/design-html/vendor/pretext.js"
[ -z "$_PRETEXT_VENDOR" ] && [ -f ~/.gemini/antigravity/skills/gstack/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=~/.gemini/antigravity/skills/gstack/design-html/vendor/pretext.js
