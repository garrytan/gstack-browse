...
```bash
~/.gemini/antigravity/skills/gstack/bin/gstack-learnings-log '{
  "type": "pitfall",
...
Read `.antigravity/skills/gstack/review/checklist.md`.
...
```bash
~/.gemini/antigravity/skills/gstack/bin/gstack-review-log '{"skill":"review","timestamp":"TIMESTAMP","status":"STATUS","issues_found":N,"critical":N,"informational":N,"quality_score":SCORE,"specialists":SPECIALISTS_JSON,"findings":FINDINGS_JSON,"commit":"COMMIT"}'
```
