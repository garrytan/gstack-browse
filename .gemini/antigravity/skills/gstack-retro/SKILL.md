...
```bash
DISCOVER_BIN=""
[ -x ~/.gemini/antigravity/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.gemini/antigravity/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .antigravity/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.antigravity/skills/gstack/bin/gstack-global-discover
