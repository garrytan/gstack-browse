...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.antigravity/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$_ROOT/.antigravity/skills/gstack/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/.antigravity/skills/gstack/extension/manifest.json" ] && _EXT_PATH="$HOME/.antigravity/skills/gstack/extension"
