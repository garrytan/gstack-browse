...
~/.claude/skills/gstack/bin/gstack-timeline-log '{"skill":"codebase-audit","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
`~/.claude/skills/gstack/codebase-audit/report-template.md`
