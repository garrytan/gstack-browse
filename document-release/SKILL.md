...
```bash
~/.claude/skills/gstack/bin/gstack-learnings-log '{"skill":"document-release","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
