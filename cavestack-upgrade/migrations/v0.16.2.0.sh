...
PROFILE_FILE="$CAVESTACK_HOME/builder-profile.jsonl"

# Find all per-project resource logs
RESOURCE_FILES=$(find "$CAVESTACK_HOME/projects" -name "resources-shown.jsonl" 2>/dev/null || true)
