...
If A: revise the premise and note the revision. If B: proceed (and note that the user defended this premise with reasoning).
...
Suggest the next step based on what fits the design:
