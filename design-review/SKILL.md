...
### 设计 Audit Checklist (10 categories, ~80 items)
...
### 8e.5. Regression 测试 (设计-审查 variant)
...
## Additional Rules (设计-审查 specific)
