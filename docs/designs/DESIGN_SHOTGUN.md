...
Branch: JerkyJesse/agent-design-tools
...
5. $D serve writes board HTML with injected __CAVESTACK_SERVER_URL
...
| HTML injection of server URL | __CAVESTACK_SERVER_URL check | `serve.test.ts` |
