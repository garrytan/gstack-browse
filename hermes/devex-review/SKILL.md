---
name: devex-review
description: Use when live developer experience audit. (Ported from gstack to Hermes)
version: 1.0.0
...
metadata:
  hermes:
    ...
    upstream: https://github.com/garrytan/gstack/blob/main/devex-review/SKILL.md
---
## When to Use
...
```bash
~/.hermes/skills/gstack/# memory tool '{"skill":"devex-review","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
