---
name: ios-clean
description: Use when remove the debugbridge spm package and all #if debug wiring from an ios app. (Ported from gstack to Hermes)
version: 1.0.0
...
metadata:
  hermes:
    ...
    upstream: https://github.com/garrytan/gstack/blob/main/ios-clean/SKILL.md
---
## When to Use
