...
description: Use when cross-model benchmark for gstack skills. (Ported from gstack to Hermes)
version: 1.0.0
...
metadata:
  hermes:
    ...
    upstream: https://github.com/garrytan/gstack/blob/main/benchmark-models/SKILL.md
---
## When to Use
...
- **Options:**
  - A) Save to `~/.hermes/gstack/benchmarks/<date>-<skill-or-prompt-slug>.json`. Completeness: 10/10.
