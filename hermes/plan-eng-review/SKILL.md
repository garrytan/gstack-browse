...
description: Use when eng manager-mode plan review. (Ported from gstack to Hermes)
version: 1.0.0
...
metadata:
  hermes:
    ...
    upstream: https://github.com/garrytan/gstack/blob/main/plan-eng-review/SKILL.md
---
## When to Use
...
> **STOP.** Before running the 4-section review, outside voice, required outputs, and review report (only after Step 0 scope is agreed), Read `~/.hermes/skills/gstack/plan-eng-review/sections/review-sections.md` and execute it
