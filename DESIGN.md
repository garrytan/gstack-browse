# Design System — nstack

## Product Context
- **What this is:** Community website for nstack — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering nstack, existing community members
