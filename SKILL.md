...
- **Starting fresh?** You have an idea but no files yet → `/hypothesis`
- **Spec exists, code doesn't?** You have spec.yaml → `/run-experiment`
- **Results exist, no report?** You have metrics.json → `/report`
- **Report exists, questions remain?** → `/discuss`
- **Ready for critical review?** → `/peer-review`
- **Starting a new cycle?** → `/hypothesis` with insights from prior work
