...
// generateBrowseMobileSetup, generateBaseBranchDetect, and generateQAMethodology moved to ./resolvers/utility.ts
// Dead copies removed — resolvers/index.ts is the source of truth for the RESOLVERS map.
