...
SKILL.md.tmpl files are **prompt templates read by Claude or Gemini**, not bash scripts.
...
could break other agent sessions using gstack concurrently.
...
When estimating or discussing effort, always show both human-team and agent+gstack time:

| Task type | Human team | Agent+gstack | Compression |
|-----------|-----------|-----------|-------------|
