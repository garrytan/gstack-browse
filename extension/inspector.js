/**
 * cavestack browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__cavestackInspectorActive) return;
  window.__cavestackInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'cavestack-inspector-highlight';
    ...
    tooltipEl.id = 'cavestack-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'cavestack-inspector-highlight' || target.id === 'cavestack-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `cavestack-inject-${id}`;
