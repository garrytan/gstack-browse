...
```bash
~/.codex/skills/gstack/bin/gstack-sync status 2>&1
```
...
```bash
~/.codex/skills/gstack/bin/gstack-sync setup 2>&1
```
...
```bash
~/.codex/skills/gstack/bin/gstack-sync test 2>&1
```
...
```bash
~/.codex/skills/gstack/bin/gstack-config get sync_enabled 2>/dev/null
~/.codex/skills/gstack/bin/gstack-config get sync_transcripts 2>/dev/null
```
...
- If they say yes:
  ```bash
  ~/.codex/skills/gstack/bin/gstack-config set sync_enabled true
  ~/.codex/skills/gstack/bin/gstack-config set sync_transcripts true
  ```
