# nstack Builder Ethos

These are the principles that shape how nstack thinks, recommends, and builds.
...
The best tools solve your own problem. nstack exists because its creator
