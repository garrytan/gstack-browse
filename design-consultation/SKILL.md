...
**Question 1 — include ALL of these:**
...
**Question 2 — present the full proposal with SAFE/RISK breakdown:**
...
Each drill-down is one focused ask the user directly. After the user decides, re-check coherence with the rest of the system.
...
**Question -final — show summary and confirm:**
