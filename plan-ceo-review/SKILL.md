...
Read ETHOS.md for Search Before Building framework. Before challenging scope, understand landscape. WebSearch for:
...
- **[Layer 3]** First-principles — where conventional wisdom wrong?

Feed into Premise Challenge (0A) and Dream State Mapping (0C). Eureka moment? Surface during Expansion opt-in as differentiation opportunity. Log it (see preamble).
