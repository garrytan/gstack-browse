...
| `/oracle` | **Product Conscience** | Persistent product memory. Bootstraps a feature map from your codebase, tracks patterns and anti-patterns across sessions, surfaces connections during planning, warns about repeated mistakes. Mostly runs silently through other skills. |
