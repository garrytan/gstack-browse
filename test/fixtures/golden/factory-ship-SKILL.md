...
1. Read `.factory/skills/cavestack/review/checklist.md`. If the file cannot be read, **STOP** and report the error.
...
Read `.factory/skills/cavestack/review/greptile-triage.md` and follow the fetch, filter, classify, and **escalation detection** steps.
