...
3. `/codex` with no arguments — **Auto-detect:**
   ...
   - If a diff exists, ask the user directly:
     ```
...
```bash
~/.codex/skills/gstack-codex/bin/gstack-review-log '{"skill":"codex-review","timestamp":"TIMESTAMP","status":"STATUS","gate":"GATE","findings":N}'
```
...
If a session file exists (not `NO_SESSION`), ask the user directly:
```
